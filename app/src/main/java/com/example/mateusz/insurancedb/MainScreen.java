...
//
//
//public class MainScreen   implements list.OnFragmentInteractionListener {
...
//        final GsonRequest gsonRequest = new GsonRequest(url, com.example.mateusz.insurancedb.model.Oc.class, null, new Response.Listener<Oc>() {
//
//            @Override
